        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-12">
          ...
          <div className="max-w-xl space-y-4">
            ...
            <p className="text-sm leading-relaxed text-[#a48e7a]/90">
              A centralized digital archive preserving the historic significance, daily rituals, and sacred traditions of temple heritage across India.
            </p>
            {/* Meta Tags/Badges */}
          ...
          <div className="w-full lg:max-w-md bg-[#2d1908]/40 border border-[#e07a16]/20 p-5 rounded-xl shadow-lg flex items-start gap-4">
            <div className="text-[#e07a16] text-xl mt-0.5">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="COUNT11.25 11.25l.041-.02a.75.75 0 111.063 1.062 11.25 11.25 0 00-1.104-.042zM12 9v1.5m0 3v3.75m9-3.75a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <div className="space-y-1">
              <h4 className="font-bold text-sm text-white">Visitor Information</h4>
              <p className="text-xs text-[#a48e7a]/80 leading-relaxed">
                Guidelines, customs, and timing schedules are verified manually by system admins. Visitors are advised to respect local traditional dress codes and photography protocols.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 text-left">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link to="/temples" className="hover:text-white transition-colors">Explore All Temples</Link></li>
              <li><Link to="/featured" className="hover:text-white transition-colors">Featured Shrines</Link></li>
              <li><Link to="/routes" className="hover:text-white transition-colors">Pilgrimage Routes</Link></li>
              <li><Link to="/festivals" className="hover:text-white transition-colors">Sacred Festivals</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link to="/methodology" className="hover:text-white transition-colors">Heritage Methodology</Link></li>
              <li><Link to="/archives" className="hover:text-white transition-colors">Contributing Archives</Link></li>
              <li><Link to="/resources" className="hover:text-white transition-colors">Academic Resources</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link to="/submit" className="hover:text-white transition-colors">Submit Temple Info</Link></li>
              <li><Link to="/report" className="hover:text-white transition-colors">Report an Error</Link></li>
              <li><Link to="/management" className="hover:text-white transition-colors">Management Portal</Link></li>
            </ul>
          </div>
